...
typedef enum {
  ...
  VCD_SIGNAL_DUMPER_VARIABLES_FRAME_RX,
  VCD_SIGNAL_DUMPER_VARIABLES_SLOT_RX,
  VCD_SIGNAL_DUMPER_VARIABLES_MCS,
  VCD_SIGNAL_DUMPER_VARIABLES_NB_RB,
...
typedef enum {
  ...
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_PRACH,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_FILL_UL_MASK,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_POWER_MEASUREMENT,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_PUCCH,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_PUSCH,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_UNSCRAMBLE_INIT,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_UNSCRAMBLING,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_POWER_ANTENNA_COMPUTATION,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_POWER_TOTAL_COMPUTATION,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_LDPC_DECODE,
  ...
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_MAIN_THREAD,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_WORKER_THREAD_0,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_WORKER_THREAD_1,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_WORKER_THREAD_2,
  VCD_SIGNAL_DUMPER_FUNCTIONS_NR_RX_WORKER_THREAD_3,
