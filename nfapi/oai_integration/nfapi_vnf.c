...
void *configure_nr_p7_vnf(void *ptr)
{
  ...
  threadCreate(&vnf_p7_start_pthread, &vnf_nr_start_p7_thread, p7_vnf->config, "vnf_p7_thread", RC.nrmac[0]->vnf_p7_thread_core, OAI_PRIORITY_RT);
#endif
  ...
  pthread_t t;
  threadCreate(&t, &vnf_timing_thread, p7_vnf, "vnf_timing", RC.nrmac[0]->vnf_timing_thread_core, OAI_PRIORITY_RT_MAX);
#endif
  return 0;
}
...
int pnf_nr_start_resp_cb(nfapi_vnf_config_t *config, int p5_idx, nfapi_nr_pnf_start_response_t *resp) {
  ...
  if(p7_vnf->thread_started == 0) {
    ...
    threadCreate(&vnf_p7_thread, &configure_nr_p7_vnf, p7_vnf, "vnf_p7_thread", RC.nrmac[0]->vnf_p7_thread_core, OAI_PRIORITY_RT);
